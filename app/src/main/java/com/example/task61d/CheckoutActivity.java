...
import com.example.task61d.databinding.FragmentUpgradeBinding;
...
import com.example.task61d.viewmodel.CheckoutViewModel;
...
import com.example.task61d.databinding.ActivityCheckoutBinding;
...
private AppCompatButton purchasebutton1;
    private @NonNull FragmentUpgradeBinding layoutBinding;
    ...
    private void initializeUi() {
        // Inflate fragment_upgrade.xml instead of activity_checkout.xml
        layoutBinding = FragmentUpgradeBinding.inflate(getLayoutInflater());
        setContentView(layoutBinding.getRoot());
        purchasebutton1 = layoutBinding.purchasebutton1;
        // Set up click listener for purchase button to trigger Google Pay
        layoutBinding.purchasebutton1.setOnClickListener(this::requestPayment);
    }
    ...
    private void setGooglePayAvailable(boolean available) {
        if (available) {
            purchasebutton1.setVisibility(View.VISIBLE);
    ...
    public void requestPayment(View view) {
        ...
        purchasebutton1.setClickable(false);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            ...
            case LOAD_PAYMENT_DATA_REQUEST_CODE:
                ...
                purchasebutton1.setClickable(true);
